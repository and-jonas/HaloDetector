...
model_rds_path = f"{workdir}/Output/Models/pls.rds"
model_dep_path = f"{workdir}/Output/Models/pls.dep"
...
class ImageSegmentor:
    ...
    @staticmethod
    def post_process_segmentation_mask(img, mask):
        """
    ...
    def iterate_images(self, img_type):
        ...
        for i, file in enumerate(files):
            ...
            num_output_name = f'{dirname}/Output/edge_labs/{f_name}.csv'
